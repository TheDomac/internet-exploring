  ...
  return (
    ...
    >
      ...
      <p>
        ...
        on Internet Exploring's Website for personal, non-commercial transitory
      ...
      <ul>
        ...
        <li>
          attempt to reverse engineer any software contained on Internet
          Exploring's Website;
        </li>
        <li>
      ...
      <p>
        This will let Internet Exploring to terminate upon violations of any of
      ...
      <p>
        All the materials on Internet Exploring’s Website are provided "as is".
        Internet Exploring makes no warranties, may it be expressed or implied,
        therefore negates all other warranties. Furthermore, Internet Exploring
      ...
      <p>
        Internet Exploring or its suppliers will not be hold accountable for any
        damages that will arise with the use or inability to use the materials
        on Internet Exploring’s Website, even if Internet Exploring or an
      ...
      <p>
        The materials appearing on Internet Exploring’s Website may include
        technical, typographical, or photographic errors. Internet Exploring
        will not promise that any of the materials in this Website are accurate,
        complete, or current. Internet Exploring may change the materials
        contained on its Website at any time without notice. Internet Exploring
      ...
      <p>
        Internet Exploring has not reviewed all of the sites linked to its
        Website and is not responsible for the contents of any such linked site.
        The presence of any link does not imply endorsement by Internet
        Exploring of the site. The use of any linked website is at the user’s
        own risk.
      </p>
      ...
      <p>
        Internet Exploring may revise these Terms of Use for its Website at any
