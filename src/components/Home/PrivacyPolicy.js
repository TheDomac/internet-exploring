...
const PrivacyPolicy = () => {
  return (
    <ScrollDiv>
      ...
      <p>
        At https://www.internetexploring.io, accessible from
        https://www.internetexploring.io, one of our main priorities is the
        privacy of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by
        https://www.internetexploring.io and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in https://www.internetexploring.io. This policy
      ...
      <p>
        https://www.internetexploring.io follows a standard procedure of using
      ...
      <p>
        Like any other website, https://www.internetexploring.io uses 'cookies'.
      ...
      <p>
        ...
        advertising partners of https://www.internetexploring.io.
      </p>
      ...
      <p>
        ...
        https://www.internetexploring.io, which are sent directly to users'
      ...
      <p>
        Note that https://www.internetexploring.io has no access to or control
      ...
      <p>
        https://www.internetexploring.io's Privacy Policy does not apply to
      ...
      <p>
        https://www.internetexploring.io does not knowingly collect any Personal
